...
namespace Livewire {
     ...
     * @method static \Illuminate\Support\Stringable|mixed|string|__anonymous@178 originalPath()
...
namespace {
    ...
    class LivewireCharts extends Asantibanez\LivewireCharts\LivewireChartsFacade {}
